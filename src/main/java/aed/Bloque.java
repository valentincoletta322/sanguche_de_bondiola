...
public class Bloque {
    ...
    private final HandleTransacciones[] arrayTransacciones;
    private final MaxHeapActualizable<HandleTransacciones> heapTransacciones;
    ...
    private class HandleTransacciones implements Comparable<HandleTransacciones> {
        private final Transaccion transaccionApuntada;
